...
function SearchContent() {
  ...
  const handleSearch = async (
    ...
    try {
      ...
      setError(
        "Failed to search images. Please check your API key and try again."
      );
      setImages([]);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen">
      <ResponsiveBanner className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 my-4" />
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mx-4 mt-4">
          ...
          <p className="text-xs mt-2">
            Make sure to replace YOUR_UNSPLASH_ACCESS_KEY with your actual
            Unsplash API key in the code.
          </p>
        </div>
      )}

      <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
